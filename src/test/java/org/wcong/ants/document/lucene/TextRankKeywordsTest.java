...
/**
 * Created by wcong on 2016/9/8.
 */
public class TextRankKeywordsTest {

    @Test
    public void testRank() throws IOException, JcsegException {
...
//3, 从一个输入reader输入流中获取关键字
        String str = "2012年从武汉到上海师范大学读了一年设计，中途辍学来日本。现在在一所东京的还算著名的美术大学里面跟着原研哉老师混了两年，要论中日两国的设计之差别，我想我还是有一些个人体会的。本来还有一大堆的课题要做，突然有一种不吐不快的感觉，现在就在微信上流传甚广的武藏野美术大学的图书馆里打完这篇文字。 \n" +
                "\n" +
